...
public class TeleportTimer extends PlayerTimer implements Listener {
    ...
    public TeleportTimer(final Bases plugin) {
    ...
    public void onPlayerMove(final PlayerMoveEvent event) {
        ...
        this.cancelTeleport(event.getPlayer(), ChatColor.WHITE + "You moved a block, therefore cancelling your teleport.");
    }
    ...
    public void onPlayerDamage(final EntityDamageEvent event) {
        ...
        if(entity instanceof Player) {
            this.cancelTeleport((Player) entity, ChatColor.WHITE + "You took damage, therefore cancelling your teleport.");
        }
    }
