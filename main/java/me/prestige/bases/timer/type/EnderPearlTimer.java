    ...
    public void onProjectileLaunch(final ProjectileLaunchEvent event) {
        ...
        if(projectile instanceof EnderPearl) {
            ...
            if(source instanceof Player) {
                ...
                if(remaining > 0L) {
                    shooter.sendMessage(ChatColor.RED + "You cannot use this for another "+ ChatColor.BOLD +  Bases.getRemaining(remaining, true, false) + ChatColor.RED + '.');
        ...
        public void run() {
            ...
            if(stack != null && stack.getType() == Material.ENDER_PEARL) {
                ...
                if(remaining > 0L) {
                    ...
                    item.c(ChatColor.WHITE + "Enderpearl Cooldown: " + ChatColor.RED + Bases.getRemaining(remaining, true, true));
