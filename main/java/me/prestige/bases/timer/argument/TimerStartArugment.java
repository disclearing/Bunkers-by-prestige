...
public class TimerStartArugment extends CommandArgument {
    ...
    public TimerStartArugment(final Bases plugin) {
    ...
    public boolean onCommand(final CommandSender sender, final Command command, final String label, final String[] args) {
        ...
        sender.sendMessage(ChatColor.WHITE + "Set timer " +  globalTimer.getDisplayName() + ChatColor.WHITE + " duration to " + ChatColor.BLUE +DurationFormatUtils.formatDurationWords(globalTimer.getRemaining(), true, true) + '.');
        return true;
    }
