...
public class TimerSetArgument extends CommandArgument {
    ...
    public TimerSetArgument(final Bases plugin) {
    ...
    public boolean onCommand(final CommandSender sender, final Command command, final String label, final String[] args) {
        ...
        if(args[2].equalsIgnoreCase("all")) {
            ...
            if(duration == 0){
                sender.sendMessage(ChatColor.WHITE + "Cleared timer " + playerTimer.getDisplayName() + ChatColor.WHITE + " for " + ChatColor.BLUE +DurationFormatUtils.formatDurationWords(duration, true, true));
            }else{
                sender.sendMessage(ChatColor.WHITE + "Set timer " + playerTimer.getDisplayName() + ChatColor.WHITE + " duration to " + ChatColor.BLUE +DurationFormatUtils.formatDurationWords(duration, true, true) + ChatColor.WHITE + " for " + ChatColor.BLUE+ target.getName() + '.');
            }
